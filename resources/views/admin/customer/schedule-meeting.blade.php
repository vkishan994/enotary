...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('customers.list', ['user_id' => $meeting->user_id, 'order_id' => $meeting->order_id]) }}"
                    ...
                    <div class="card-body">
                                    ...
                                    <select name="status" id="statusSelect" class="form-select" required>
                                        ...
                                        @if ($meeting->status !== 'approved')
                                            <option value="rejected"
                                                {{ $meeting->status === 'rejected' ? 'selected' : '' }}>
                                                Reject
                                            </option>
                                        @endif
                                        ...
                                        @if ($meeting->status == 'approved')
                                            <option value="verified"
                                                {{ $meeting->status === 'verified' ? 'selected' : '' }}>
                                                Verified
                                            </option>
                                        @endif
                        ...
                        @if ($meeting->status == 'approved')
                            <div class="d-flex flex-column mt-3" style="min-width:140px;">
                                <a class="meeting-link-btn btn btn-primary" href="{{ $meeting->google_meet_link }}"
                                    target="_blank">
                                    Join Meeting
                                </a>
