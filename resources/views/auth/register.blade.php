...
<head>
    ...
    <!-- Site Title -->
    <title>Sign Up | White Horse Solicitors & Notary Public</title>
                ...
                <div class="col-lg-7 col-md-12 signup-form-section">
                    <div class="signup-form-wrapper">
                        <div class="login-header">
                            ...
                            <h2 class="signup-title">New to Whitehorse?</h2>
                        ...
                        <form actio="{{ route('register') }}" method="post" class="signup-form">
                            ...
                            <div class="form-group">
                                <input type="text" id="last_name" name="last_name"
                                    class="form-control @error('last_name') is-invalid @enderror" placeholder="Surname"
                                    required />
                                @error('last_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group" style="position: relative;">
                                <input type="password" id="password" name="password"
                                    ...
                                    placeholder="Create your password" required style="padding-right: 40px;" />
